...
description: Complete guide for new users to understand CAIRA's AI agents and deploy Azure AI infrastructure with ease.
author: CAIRA Team
ms.date: 03/03/2026
ms.topic: guide
...
In your development environment, select the `CAIRA AI Assistant` agent.
