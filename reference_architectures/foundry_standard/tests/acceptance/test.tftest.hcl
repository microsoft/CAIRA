...
run "testacc_foundry_standard_custom_project" {
  command = plan
...
run "testacc_foundry_standard_sku_validation" {
  command = plan
...
run "testacc_foundry_standard_with_tags" {
  command = plan
...
run "testacc_foundry_standard_telemetry_disabled" {
  command = plan
...
run "testacc_foundry_standard_null_tags" {
  command = plan
...
run "testacc_foundry_standard_defaults_validation" {
  command = plan
